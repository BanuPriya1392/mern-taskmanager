...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-violet-600/20 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="glass-card rounded-2xl shadow-xl p-8 w-full max-w-md animate-fade-in relative z-10">
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          ...
          <Link to="/login" className="text-indigo-400 font-semibold hover:text-indigo-300 transition hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
